        ...
        <table>
          ...
          <tr>
            <?php
              ...
              $sql="select * from place_order"; // status=1 order is ongoing and status=0 order is done
              ...
              if($result && $result->num_rows>0){
                while($row=$result->fetch_assoc()){
                  ...
                  echo "
                    ...
                    <td>
                      <a href='place_order_delete.php?email=$row[email]&id=$row[id]' style='color: red; font-size: 25px;'><i class='fas fa-trash-alt'></i></a>
                    </td>
